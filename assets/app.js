(() => {
  ...
  function openCustomer(id=null){
    ...
    openModal(id?'Edit customer':'New customer','CLIENT',`<div class="form-grid">
      ...
      const data={company:val('#cCompany'),title:val('#cTitle'),firstName:val('#cFirstName'),surname:val('#cSurname'),jobTitle:val('#cJobTitle'),telephone:val('#cTelephone'),mobile:val('#cMobile'),email:val('#cEmail'),website:val('#cWebsite'),notes:val('#cNotes')};
