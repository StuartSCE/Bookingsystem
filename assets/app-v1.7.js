(() => {
  ...
  function openBooking(id=null){
    ...
    openModal(id?'Manage booking':'New booking','EVENT',`<div class="booking-form" style="display:block!important;width:100%!important;">
      <section class="booking-section booking-section-first" style="display:block!important;width:100%!important;margin:0 0 42px!important;padding:0 0 34px!important;border-bottom:1px solid var(--line)!important;">
        ...
        <div class="booking-section-fields" style="display:flex!important;flex-direction:column!important;align-items:stretch!important;width:100%!important;gap:18px!important;">
          <div class="field" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>DATE</label><input id="bDate" type="date" value="${esc(b.eventDate||'')}"></div>
          <div class="field" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>EVENT TITLE</label><input id="bTitle" value="${esc(b.title||'')}"></div>
          <div class="field full" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>ENTERTAINMENT</label><select id="bEntertainment"><option value="">Choose…</option>${(state.services||[]).map(s=>`<option value="${s.id}" ${entertainmentId===s.id||(!entertainmentId&&entertainmentName===s.name)?'selected':''}>${esc(s.name)}</option>`).join('')}</select></div>
        </div>
      </section>

      <section class="booking-section" style="display:block!important;width:100%!important;margin:0 0 42px!important;padding:0 0 34px!important;border-top:0!important;border-bottom:1px solid var(--line)!important;">
        <div class="booking-section-heading" style="display:block!important;width:100%!important;margin:0 0 22px!important;padding:0!important;">VENUE DETAILS</div>
        <div class="booking-section-fields" style="display:flex!important;flex-direction:column!important;align-items:stretch!important;width:100%!important;gap:18px!important;">
          <div class="field full" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>ADDRESS QUICK SEARCH</label><input id="bVenueQuickSearch" value="${esc(b.venueQuickSearch||'')}" placeholder="Start typing a venue, address or postcode…" autocomplete="off"><div class="helper" id="bookingAddressLookupStatus">Start typing and choose an address from the suggestions.</div></div>
          <div class="field full" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>VENUE NAME</label><input id="bVenueName" value="${esc(venueName)}"></div>
          <div class="field full" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>VENUE ADDRESS</label><textarea id="bVenueAddress">${esc(b.venueAddress||'')}</textarea></div>
          <div class="field" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>VENUE POSTCODE</label><input id="bVenuePostcode" value="${esc(b.venuePostcode||'')}"></div>
          <div class="field" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>VENUE TELEPHONE</label><input id="bVenueTelephone" type="tel" value="${esc(b.venueTelephone||'')}"></div>
          <div class="field full" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>VENUE NOTES</label><textarea id="bVenueNotes">${esc(b.venueNotes||b.notes||'')}</textarea></div>
        </div>
      </section>

      <section class="booking-section" style="display:block!important;width:100%!important;margin:0 0 42px!important;padding:0 0 34px!important;border-top:0!important;border-bottom:1px solid var(--line)!important;">
        <div class="booking-section-heading" style="display:block!important;width:100%!important;margin:0 0 22px!important;padding:0!important;">TIMINGS <span>(enter in HH:mm format)</span></div>
        <div class="booking-section-fields" style="display:flex!important;flex-direction:column!important;align-items:stretch!important;width:100%!important;gap:18px!important;">
          <div class="field" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>ARRIVAL TIME</label><input id="bArrivalTime" type="time" value="${esc(b.arrivalTime||'')}"></div>
          <div class="field" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>START TIME</label><input id="bStartTime" type="time" value="${esc(b.startTime||'')}"></div>
          <div class="field" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>FINISH TIME</label><input id="bFinishTime" type="time" value="${esc(finishTime)}" ${noFinishTime?'disabled':''}></div>
          <div class="field booking-checkbox-field" style="display:block!important;width:100%!important;grid-column:auto!important;"><label class="toggle"><input id="bNoFinishTime" type="checkbox" ${noFinishTime?'checked':''}> No Finish Time</label></div>
          <div class="field full booking-checkbox-field" style="display:block!important;width:100%!important;grid-column:auto!important;"><label class="toggle"><input id="bShiftTimeZone" type="checkbox" ${b.shiftTimeZone?'checked':''}> Shift Time Zone</label></div>
        </div>
      </section>

      <section class="booking-section" style="display:block!important;width:100%!important;margin:0 0 42px!important;padding:0 0 34px!important;border-top:0!important;border-bottom:1px solid var(--line)!important;">
        <div class="booking-section-heading" style="display:block!important;width:100%!important;margin:0 0 22px!important;padding:0!important;">OTHER INFORMATION</div>
        <div class="booking-section-fields" style="display:flex!important;flex-direction:column!important;align-items:stretch!important;width:100%!important;gap:18px!important;">
          <div class="field" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>EVENT CONTACT</label><input id="bEventContact" list="bookingCustomerNames" value="${esc(eventContact)}"><datalist id="bookingCustomerNames">${(state.customers||[]).map(c=>`<option value="${esc(customerDisplayName(c))}"></option>`).join('')}</datalist></div>
          <div class="field" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>TELEPHONE</label><input id="bEventTelephone" type="tel" value="${esc(b.eventTelephone||'')}"></div>
          <div class="field" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>DRESS CODE</label><input id="bDressCode" value="${esc(b.dressCode||'')}"></div>
          <div class="field" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>NO. OF GUESTS</label><input id="bGuestCount" type="number" min="0" step="1" value="${esc(b.guestCount??'')}"></div>
        </div>
      </section>

      <section class="booking-section" style="display:block!important;width:100%!important;margin:0 0 42px!important;padding:0 0 34px!important;border-top:0!important;border-bottom:1px solid var(--line)!important;">
        <div class="booking-section-heading" style="display:block!important;width:100%!important;margin:0 0 22px!important;padding:0!important;">FEES</div>
        <div class="booking-section-fields" style="display:flex!important;flex-direction:column!important;align-items:stretch!important;width:100%!important;gap:18px!important;">
          <div class="field" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>FEE</label><input id="bFee" type="number" min="0" step="0.01" value="${esc(fee||'')}"></div>
          <div class="field" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>OTHER SERVICES TOTAL</label><input id="bOtherServicesTotal" type="number" min="0" step="0.01" value="${esc(otherServicesTotal)}" readonly><div class="helper">Calculated from additional services when added.</div></div>
          <div class="field" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>GRAND TOTAL</label><input id="bGrandTotal" type="number" step="0.01" value="${esc(grandTotal)}" readonly></div>
          <div class="field" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>DEPOSIT</label><input id="bDeposit" type="number" min="0" step="0.01" value="${esc(b.deposit||'')}"></div>
          <div class="field full" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>PAYMENT INSTRUCTIONS</label><textarea id="bPaymentInstructions" placeholder="e.g. Bank transfer details, payment schedule or client instructions…">${esc(b.paymentInstructions||'')}</textarea></div>
        </div>
      </section>
      ${id?`
        <section class="booking-section" style="display:block!important;width:100%!important;margin:0 0 42px!important;padding:0 0 34px!important;border-top:0!important;border-bottom:1px solid var(--line)!important;">
          <div class="booking-section-heading" style="display:block!important;width:100%!important;margin:0 0 22px!important;padding:0!important;">BOOKING MANAGEMENT</div>
          <div class="booking-section-fields" style="display:flex!important;flex-direction:column!important;align-items:stretch!important;width:100%!important;gap:18px!important;">
            <div class="field" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>STATUS</label><select id="bStatus">${['Enquiry','Date Held','Contract Issued','Confirmed','Completed','Cancelled'].map(x=>`<option ${b.status===x?'selected':''}>${x}</option>`).join('')}</select></div>
            <div class="field" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>CONTRACT STATUS</label><select id="bContractStatus">${['Draft','Sent','Accepted','Declined'].map(x=>`<option ${b.contractStatus===x?'selected':''}>${x}</option>`).join('')}</select></div>
            <div class="field full" style="display:block!important;width:100%!important;grid-column:auto!important;"><label>LINKED CUSTOMER</label><select id="bCustomer"><option value="">None</option>${(state.customers||[]).map(c=>`<option value="${c.id}" ${b.customerId===c.id?'selected':''}>${esc(customerDisplayName(c))}</option>`).join('')}</select></div>
            <div class="field full" style="display:block!important;width:100%!important;grid-column:auto!important;"><div class="notice">Client portal link: <b>client.html?booking=${esc(b.id)}</b>.</div></div>
          </div>
        </section>`:''}
